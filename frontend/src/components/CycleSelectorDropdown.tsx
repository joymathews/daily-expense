  ...
  return (
    <div className={`inline-flex items-center gap-2 ${className}`}>
      ...
      <select
        ...
        className="bg-white/80 dark:bg-slate-800/80 backdrop-blur border border-indigo-200 dark:border-indigo-900/50 text-indigo-900 dark:text-indigo-200 text-xs font-medium rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm transition-all"
